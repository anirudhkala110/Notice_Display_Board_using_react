...
export const Timetableupdate3yrsem1 = () => {
        ...
        <>
            ...
            <div className="baseforeverypage">
                <div className="mainframe">
                    <h3>Time Table Update -3rd year Semester 1</h3>
                        ...
                        <div className="deletingsubjects">
                            <form action="" method="get">
                                <div className="Timetableupdatesubclass">
                                    ...
                                    <input type="text" value={"XYZ"} name='Scode' id="noticeheading" onChange={(e) => senduser(e)} required />
...
export default Timetableupdate3yrsem1