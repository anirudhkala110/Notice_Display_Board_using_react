...
export const Uploadupdatedexternalcircular = () => {
        ...
        <div className="mainframe">
          ...
          <div className="uploadnotices">
            <form action="" method="post">
              ...
              <div className="subclass">
                <label htmlFor="">Type-External Circular:</label>
                <textarea
                  name="detail"
                  rows={20}
                  id="textarea"
                  required
                  defaultValue={""} onChange={(e) => senduser(e)} />
              </div>
              <div className="subclass">
...
export default Uploadupdatedexternalcircular