...
export const Timetableuploadupdate3yrsem2 = () => {
        ...
        <>
            ...
            <div className="baseforeverypage">
                <div className="mainframe">
                    <h3>Time Table Update -3rd year Semester 2</h3>
                    <div className="Updatetimetableinfo">
                        <form action="" method="post">
                            ...
                            <div className="Timetablesubclass" />
                            <button className="uploadsubmit" aria-readonly>Update</button>
                        </form>
                    </div>
                </div>
            </div>
...
export default Timetableuploadupdate3yrsem2